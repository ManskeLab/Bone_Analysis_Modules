...
#
#-----------------------------------------------------
# Usage:       python CBCTCorticalBreakLogic.py inputImage inputContour outputImage 
...
if __name__ == "__main__":
    ...
    erosion = CBCTCorticalBreakLogic(img, contour, voxelSize, lower, upper, 
