...
#-----------------------------------------------------
# Usage:       python PetersCorticalBreakLogic.py inputImage inputContour outputImage
...
class PetersCorticalBreakLogic:
...
if __name__ == "__main__":
    ...
    erosion = PetersCorticalBreakLogic(img, contour, voxelSize, lower, upper,
