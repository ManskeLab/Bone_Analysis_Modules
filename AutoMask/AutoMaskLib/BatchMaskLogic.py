...
#
# Description: This script runs mask algorithm on a batch of greyscale scans.
...
#
#-----------------------------------------------------
# Usage:       python BatchMaskLogic.py inputDirectory outputDirectory 
...
for file in os.listdir(input_dir):
    ...
    # set mask algorithm parameters
    mask.setImage(img)
    mask.setRoughMask(roughMask)
    mask.setThreshold(lower, upper)
    mask.setBoneNum(boneNum)
    ...
    sitk.WriteImage(mask_img, output_file)
